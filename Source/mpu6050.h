...
#define MPU6050_ADDRESS             (0x68 << 1) // 0x69 when AD0 pin to Vcc
...
typedef enum
{
    MPU6050_CLOCK_KEEP_RESET      = 7,	//0b111,
    MPU6050_CLOCK_EXTERNAL_19MHZ  = 5,	//0b101,
    MPU6050_CLOCK_EXTERNAL_32KHZ  = 4,	//0b100,
    MPU6050_CLOCK_PLL_ZGYRO       = 3,	//0b011,
    MPU6050_CLOCK_PLL_YGYRO       = 2,	//0b010,
    MPU6050_CLOCK_PLL_XGYRO       = 1,	//0b001,
    MPU6050_CLOCK_INTERNAL_8MHZ   = 0	//0b000
} mpu6050_clockSource_t;

typedef enum
{
    MPU6050_SCALE_2000DPS         = 3,	//0b11,
    MPU6050_SCALE_1000DPS         = 2,	//0b10,
    MPU6050_SCALE_500DPS          = 1,	//0b01,
    MPU6050_SCALE_250DPS          = 0	//0b00
} mpu6050_dps_t;

typedef enum
{
    MPU6050_RANGE_16G             = 3,	//0b11,
    MPU6050_RANGE_8G              = 2,	//0b10,
    MPU6050_RANGE_4G              = 1,	//0b01,
    MPU6050_RANGE_2G              = 0	//0b00,
} mpu6050_range_t;

typedef enum
{
    MPU6050_DELAY_3MS             = 3,	//0b11,
    MPU6050_DELAY_2MS             = 2,	//0b10,
    MPU6050_DELAY_1MS             = 1,	//0b01,
    MPU6050_NO_DELAY              = 0	//0b00,
} mpu6050_onDelay_t;

typedef enum
{
    MPU6050_DHPF_HOLD             = 7,	//0b111,
    MPU6050_DHPF_0_63HZ           = 4,	//0b100,
    MPU6050_DHPF_1_25HZ           = 3,	//0b011,
    MPU6050_DHPF_2_5HZ            = 2,	//0b010,
    MPU6050_DHPF_5HZ              = 1,	//0b001,
    MPU6050_DHPF_RESET            = 0	//0b000,
} mpu6050_dhpf_t;

typedef enum
{
    MPU6050_DLPF_6                = 6,	//0b110,
    MPU6050_DLPF_5                = 5,	//0b101,
    MPU6050_DLPF_4                = 4,	//0b100,
    MPU6050_DLPF_3                = 3,	//0b011,
    MPU6050_DLPF_2                = 2,	//0b010,
    MPU6050_DLPF_1                = 1,	//0b001,
    MPU6050_DLPF_0                = 0	//0b000,
} mpu6050_dlpf_t;
